...
demography.add_instantaneous_bottleneck(time=100*gy, strength=1200*gy, population="Sake")
...
demography.add_instantaneous_bottleneck(time=750*gy, strength=200*gy, population="Kveik")
demography.add_instantaneous_bottleneck(time=880*gy, strength=200*gy, population="Kveik")
demography.add_instantaneous_bottleneck(time=980*gy, strength=200*gy, population="Kveik")
demography.add_instantaneous_bottleneck(time=1080*gy, strength=200*gy, population="Kveik")

demography.add_population_split(1500*gy, derived=["Kveik", "Beer1"], ancestral="Beer")
...
print(demography)
tup=list(product(["Wild","Sake","Ale", "Lager"],range(1,11)))+list(product(["Kveik"],range(1,21)))
nams=list(map(lambda x: x[0]+"_"+str(x[1]), tup))

ts = msprime.sim_ancestry(
    {"Wild":10, "Sake":10, "Ale":10, "Lager":10, "Kveik":20},
