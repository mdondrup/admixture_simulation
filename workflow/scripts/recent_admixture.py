...
#demography.add_instantaneous_bottleneck(time=100*gy, strength=500*gy, population="Sake")
#demography.add_instantaneous_bottleneck(time=200*gy, strength=500*gy, population="Lager")
demography.add_population_split(500*gy, derived=["Lager", "Ale"], ancestral="Beer0")
demography.add_admixture(time=600*gy, derived="Kveik", ancestral=["Beer0", "Sake"], proportions=[0.5, 0.5])
demography.add_population_split(1000*gy, derived=[ "Beer0"], ancestral="Beer")
