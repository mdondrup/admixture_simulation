...
demography.add_instantaneous_bottleneck(time=750*gy, strength=50*gy, population="Kveik")
demography.add_instantaneous_bottleneck(time=880*gy, strength=50*gy, population="Kveik")
demography.add_instantaneous_bottleneck(time=980*gy, strength=50*gy, population="Kveik")
demography.add_instantaneous_bottleneck(time=1080*gy, strength=100*gy, population="Kveik")
